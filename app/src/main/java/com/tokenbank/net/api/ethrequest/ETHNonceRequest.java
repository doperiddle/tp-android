...
public class ETHNonceRequest extends BaseGetApiRequest {

    private final String mAddress;

    public ETHNonceRequest(String address) {
        mAddress = address;
    }
    ...
    public String initUrl() {
        String url = Constant.etherscan_base_url
                + "?module=proxy&action=eth_getTransactionCount&address=" + mAddress + "&tag=latest";
